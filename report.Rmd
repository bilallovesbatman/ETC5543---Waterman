---
title: "Waterman Workspaces Customer Churn Analysis: CRM Cases"
author: "Bilal Raja"
date: "`r Sys.Date()`"
output:
...
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "H", fig.pos = "H")
```
...
mcfadden_r2 <- suppressMessages(pR2(log_model)["McFadden"])
...
Xie Y (2016). _bookdown: Authoring Books and Technical Documents with R Markdown_. Chapman and Hall/CRC, Boca Raton, Florida. ISBN 978-1138700109, <https://bookdown.org/yihui/bookdown>.
